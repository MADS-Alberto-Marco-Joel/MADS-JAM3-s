...
namespace ProjetoArvore
{
    public class RepositorioArvores
    {
        ...
        public RepositorioArvores()
        {
            ...
            Arvore arvore = new() { Id = 1, NomeCientifico = 2, Altura = 2.50f, Diametro = 3.60f, Perimetro = 100f, Classificacao = 10, IdConstrucao = 1, Localizacao = "porto", ValidFrom = DateOnly.Parse("2022-02-06"), ValidTo = default };
