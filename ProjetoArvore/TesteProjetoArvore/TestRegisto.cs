    ...
    public class Tests
    {
       [Test]
        public void ValidarRegisto()
        {
            ...
            Arvore arvore= new() { Id = 2, NomeCientifico = "Arvoris Grandolis", Altura = 2.50f, Diametro = 3.60f, Perimetro = 100f, Classificacao = 10, IdConstrucao = 1, Localizacao = "porto", ValidFrom = DateOnly.Parse("2022-02-06"), ValidTo = DateOnly.Parse("2022-02-06") };
